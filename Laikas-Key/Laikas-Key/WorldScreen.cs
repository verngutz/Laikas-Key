...
namespace Laikas_Key
{
    class WorldScreen : MiScreen
    {
        ...
        {   
            if (activeLocation.Equals(LocationData.State.ALLY.Equals(true)))
            {
                MessageScreen.Show("Locations with green markers are controlled by your faction.");
                return;
            }
            else if (activeLocation.Equals(LocationData.State.ENEMY.Equals(true)))
            {
                MessageScreen.Show("Locations with red markers are controlled by the enemy faction.");
                return;
            }
            else if (activeLocation.Equals(LocationData.State.NEUTRAL.Equals(true)))
            {
